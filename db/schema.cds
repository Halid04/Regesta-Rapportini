...
entity TblRapportini
{
   key IDRapportino: Integer @(IncrementalCounter: true, InitialValue: 1);
    IDUtente : Integer;
    utente : String(50);
    ...
    IDCorso : Integer;
    amsh24 : Boolean;
    Cliente : Association to one TblClienti;
    Commessa : Association to one TblCommesse;
}

entity TblClienti
{
   @ObjectModel.incremental : true key IDCliente : Integer default 1;
    codice : String(50);
    descrizione : String(250);
    password : String(250);
...
entity TblRapportiniAllegati
{
   @ObjectModel.incremental : true key IDRapportinoAllegato : Integer;
    IDRapportino : Integer;
    allegato : String(250);
    descrizione : String(250);
}

entity TblClientiSedi
{
   @ObjectModel.incremental : true key IDClienteSede : Integer default 1;
    IDCliente : Integer;
...
entity TblTodoList
{
   @ObjectModel.incremental : true key IDTodolist : Integer default 1;
    insertDate : DateTime;
    utente : String(50);
    IDCliente : Integer;
    IDcommessa : Integer;
...
entity TblCommesse
{
    key IDCommessa : Integer default 1;
    IDSocieta : Integer;
    codice : String(50);
